...
namespace IFoxtec.WPF.Module.Home
{
    ...
    {
        public BaseContextViewModel(IAbpSession session)
        {
        ...
        private void InitSampleData()
        {
            ...
            { 
                ...
                {
                    new MenuDescription("用户管理") { DocumnetType = ViewIndex.UserList ,Icon = DXImageHelper.GetImageSource(DXImages.Currency, ImageSize.Size16x16)},
