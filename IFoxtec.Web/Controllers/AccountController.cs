...
using IFoxtec.Sessions;
using IFoxtec.Web.Controllers.Results;
using IFoxtec.Web.Models;
using IFoxtec.Web.Models.Account;
using Microsoft.AspNet.Identity;
using Microsoft.AspNet.Identity.Owin;
using Microsoft.Owin.Security;

namespace IFoxtec.Web.Controllers
{
    public class AccountController : IFoxtecControllerBase
    {
